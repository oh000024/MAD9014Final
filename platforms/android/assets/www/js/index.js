...
const GLOBALKEY = "oh000024scores";
...
//			away.innerHTML = awayTeam + " " + "<b>" + item.away_score + "</b>" + "&nbsp" + "<br>";
//			//away.style.backgroundColor = "#C4EDDE";
//			//            
//			//dg.style.backgroundcolor="red";
//			dg.appendChild(home);
//			dg.appendChild(away);
//			dg.innerHTML += "<hr>";
//			ul.appendChild(dg);
